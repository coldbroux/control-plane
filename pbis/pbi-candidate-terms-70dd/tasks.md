...
|---|---|---|---|
| 1 | `Schema migration for semantic_modeling.candidate_terms` (`1.md`) | Proposed | Create the `semantic_modeling` schema with `candidate_terms` and `candidate_term_observations` tables, lifecycle constraints, partial unique index, and supporting indexes. |
