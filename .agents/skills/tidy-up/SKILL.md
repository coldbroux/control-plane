---
name: tidy-up
description: Scan the current repo for stale branches, worktrees, stashes, and uncommitted work; summarize findings and recommend a cleanup strategy (isolate, consolidate, or purge) for explicit human approval before any destructive action.
risk: high
source: local
---
