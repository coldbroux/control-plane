...
description: Create or update skills in `.agents/skills/` so they're available to all agents. Use when encoding a new reusable workflow or editing an existing skill.
risk: medium
source: local
---
