...
description: Use when creating a new agent skill or updating an existing one — ensures proper directory structure, Claude Code command registration, and registration in all agent config files (README, AGENTS.md).
risk: low
source: local
---
